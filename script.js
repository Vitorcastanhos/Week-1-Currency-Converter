...
async function getExchangeRate() {
	...
	try {
		const response = await fetch(`https://v6.exchangerate-api.com/v6/3fb17773cd62da6f0adec1ef/latest/${fromCur.value}`);
...
// Event listener for the button and the exchange icon click events
